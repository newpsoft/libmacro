...
#ifndef MCR_EXTRAS_TRIGGERS_STAGED_H_
#define MCR_EXTRAS_TRIGGERS_STAGED_H_

#include "mcr/extras/itrigger_member.h"

namespace mcr
{
/*! Pause execution until a specific date-time. */
class MCR_API Staged : public ITriggerMember
{
public:
	tm time;
	...
	{
		return (Alarm *)(sigPt ? sigPt->instance.data_member.data : NULL);
	}
